...
namespace Castle.DynamicProxy
{
	...
	public class ModuleScope
	{
		...
		{
			byte[] keyPair;
			using (Stream stream = Assembly.GetExecutingAssembly ().GetManifestResourceStream("OX.Strongbind.OX.Strongbind.snk"))
			{
				if (stream == null)
					throw new MissingManifestResourceException (
                        "Should have a OX.Strongbind.OX.Strongbind.snk as an embedded resource, so Dynamic Proxy could sign generated assembly");
